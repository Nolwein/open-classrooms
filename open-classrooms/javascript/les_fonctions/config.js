// Liste des mots utilisés pour le jeu et commme elles ne sont pas dans un bloc de code elles ont une portée globale, donc sont utilisable dans script.js
...
function afficherResultat(score,nombreTotalMots){
  "Votre score est de " + score + " sur " + nombreTotalMots
}
